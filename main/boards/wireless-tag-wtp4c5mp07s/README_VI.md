...
* [Wireless-Tag WT99P4C5-S1](https://en.wireless-tag.com/product-item-66.html) ESP32-P4 phát triển board and
...
* Select Wi-Fi buffers
        ...
        Component config -> Wi-Fi Remote -> Wi-Fi cấu hình -> Max number of WiFi static RX buffers -> 10
        Component config -> Wi-Fi Remote -> Wi-Fi cấu hình -> Max number of WiFi dynamic RX buffers -> 24
        Component config -> Wi-Fi Remote -> Wi-Fi cấu hình -> Max number of WiFi static TX buffers -> 10
